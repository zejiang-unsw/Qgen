...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), paste0('NPRED_r20_val'))) }) #,format(Sys.time(),"%Y-%m-%d %H %M")))) })
editor_options: 
