...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), paste0('NPRED_r100_Pesudo'))) }) #,format(Sys.time(),"%Y-%m-%d %H %M")))) })
editor_options: 
...
path.out <- paste0(station_id,"/cli_mod_Pesudo/","/mod_",mod_id,"/")
