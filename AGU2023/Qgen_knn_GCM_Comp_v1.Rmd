...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), paste0('NPRED_GCM_r100_comp_v1'))) }) #,format(Sys.time(),"%Y-%m-%d %H %M")))) })
editor_options: 
...
path.out <- paste0(station_id,"/cli_mod_hist_A/") 
