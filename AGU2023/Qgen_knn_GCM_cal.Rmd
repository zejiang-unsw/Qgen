...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), paste0('NPRED_GCM_r100_cal_A_v2'))) }) #,format(Sys.time(),"%Y-%m-%d %H %M")))) })
editor_options: 
