...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), paste0('NPRED_r100_val_D_v1'))) }) #,format(Sys.time(),"%Y-%m-%d %H %M")))) })
editor_options: 
